...
function ModifyClient(props){
    ...
    return(
        ...
        <div className='row justify-content-start d-flex' style={{width:'100%'}}>
                ...
                <div className='col-6 col-lg-6 text-start d-flex justify-content-start' style={{gap:"24px"}}>
                <button className='andent-button-red'>
                    <h2 className='button-text'>
                            Delete Client<span style={{marginLeft:"8px",bottom:"2px",position:"relative"}}>
